    ...
    <main className="app-shell">
      <section className="terminal-card" aria-labelledby="title">
        ...
        <form onSubmit={handlePredict}>
          ...
          <button className="predict-button" disabled={isLoading} type="submit">
            <span>{isLoading ? 'Analysing...' : 'Predict digit'}</span><b>→</b>
          </button>
        </form>
      ...
      {prediction && (
        <section className="result-card" aria-live="polite">
          ...
          <dl>
            <div><dt>Digit</dt><dd>{prediction.digit}</dd></div>
            ...
            <div><dt>Test Accuracy</dt><dd>{prediction.test_accuracy.toFixed(1)}%</dd></div>
          </dl>
        </section>
      )}
    </main>
